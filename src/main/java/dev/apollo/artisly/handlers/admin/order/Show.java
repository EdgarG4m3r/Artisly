...
public class Show implements APIHandler {
    ...
    public void handle(Context context) {
        ...
        {
            StandarizedResponses.generalFailure(context, 500, "SQL_EXCEPTION", "Gagal saat mengambil order!");
        } catch (UserNotFoundException e) {
            StandarizedResponses.generalFailure(context, 404, "USER_NOT_FOUND", "Tidak dapat menemukan user.");
        }
    }
}
