...
public class Show implements APIHandler {
    ...
    public void handle(Context context) {
        ...
        try {
            Address address = AddressService.readAddress(userSessionContainer.getUser().id(), addressId);
            StandarizedResponses.success(context, "SUCCESS", "Berhasil mengambil alamat", "address", address.toJSON());
            ...
            StandarizedResponses.generalFailure(context, 400, "INVALID_ADDRESS_EXCEPTION", "Alamat yang ingin anda ambil tidak ditemukan");
            return;
        }
