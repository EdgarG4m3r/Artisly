...
public class Remove implements APIHandler {
    ...
    public void handle(Context context) {
        ...
        WishlistManager.removeProductFromWishlist(userSessionContainer.getUser().id(), productId);
        StandarizedResponses.success(context, "SUCCESS", "Berhasil menghapus produk dari wishlist.");
    }
}
